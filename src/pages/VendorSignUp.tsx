        ...
        <Card className="w-full max-w-2xl">
          <CardHeader className="text-center">
            <div className="flex items-center justify-center mb-4">
              <Building2 className="h-8 w-8 text-[#917f4f] mr-2" />
              <CardTitle className="text-2xl font-bold">Join as a Vendor</CardTitle>
            </div>
            <CardDescription>
              Start showcasing your wedding services to couples across Sri Lanka
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="agreeToMarketing" className="text-sm">
                    I'd like to receive business tips and promotional offers via email
                  </Label>
                </div>
              </div>
              
              <Button type="submit" className="w-full bg-[#917f4f] hover:bg-[#7a6a42]" disabled={isLoading}>
            ...
            <div className="text-center text-sm">
              Looking to plan your wedding?{' '}
              <Link to="/signup" className="text-[#917f4f] hover:underline font-medium">
                Create a bride/groom account
              </Link>
            </div>
          </CardContent>
        </Card>
